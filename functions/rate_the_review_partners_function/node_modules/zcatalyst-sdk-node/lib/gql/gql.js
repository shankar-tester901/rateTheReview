...
var CatalystGQLError = require('../utils/error').CatalystGQLError;
var GQL = /** @class */ (function (_super) {
    __extends(GQL, _super);
    function GQL(app) {
        var _this = this;
        isValidApp(app, true);
    ...
    GQL.prototype.executeGQL = function (gql) {
        var _this = this;
        return wrapValidatorsWithPromise(function () {
            isNonEmptyString(gql, 'gql_query', true);
        }, CatalystGQLError).then(function () {
            var postData = {
                query: gql
            };
            var request = {
                method: 'POST',
                path: "/" + PRODUCT_NAME + "/" + API_VERSION + "/project/" + _this.projectId + "/gql/execute",
                data: postData,
                type: 'json'
            };
