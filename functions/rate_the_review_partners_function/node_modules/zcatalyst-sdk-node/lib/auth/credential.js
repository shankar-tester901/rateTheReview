...
function requestAccessToken(request) {
    return new HttpClient().send(request).then(function (resp) {
        var json = resp.data;
        if (json.error) {
...
var RefreshToken = /** @class */ (function () {
    function RefreshToken(json) {
        ...
        if (typeof errorMessage !== 'undefined') {
            throw new CatalystAuthError('invalid_credential', errorMessage, this.refreshToken);
        }
    }
    return RefreshToken;
}());
var AccessToken = /** @class */ (function () {
    function AccessToken(json) {
        ...
        if (typeof errorMessage !== 'undefined') {
            throw new CatalystAuthError('invalid_credential', errorMessage, this.accessToken);
        }
    }
    return AccessToken;
}());
var Ticket = /** @class */ (function () {
    function Ticket(json) {
        ...
        if (typeof errorMessage !== 'undefined') {
            throw new CatalystAuthError('invalid_credential', errorMessage, this.ticket);
        }
    }
    return Ticket;
}());
var RefreshTokenCredential = /** @class */ (function (_super) {
    __extends(RefreshTokenCredential, _super);
    function RefreshTokenCredential(refreshTokenObject) {
        return _super.call(this, refreshTokenObject) || this;
    }
    RefreshTokenCredential.prototype.getAccessToken = function () {
        var request = {
            method: constants.REQUEST.post,
...
var AccessTokenCredential = /** @class */ (function (_super) {
    __extends(AccessTokenCredential, _super);
    function AccessTokenCredential(accessTokenObject) {
        return _super.call(this, accessTokenObject) || this;
    }
...
var TicketCredential = /** @class */ (function (_super) {
    __extends(TicketCredential, _super);
    function TicketCredential(ticketObj) {
        return _super.call(this, ticketObj) || this;
    }
...
var ObjectCredential = /** @class */ (function () {
    function ObjectCredential(obj, key, user) {
        ...
        this.cookieStr = obj[key][constants.CREDENTIAL_HEADER.cookie];
        if (!this.adminType || !this.adminToken) {
            throw new CatalystAuthError('invalid_credential', 'missing admin credentials', obj);
        }
        if ((!this.userType || !this.userToken) && !this.cookieStr) {
            throw new CatalystAuthError('invalid_credential', 'missing user credentials', obj);
        }
    ...
    ObjectCredential.prototype.getCookieString = function () {
        if (this.cookieStr) {
    ...
    ObjectCredential.prototype.getCurrentUser = function () {
        return this.user;
    };
